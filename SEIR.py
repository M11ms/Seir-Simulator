...
if st.button("เริ่มการจำลอง"):
    ...
    st.markdown("### 📌 FAQ")
    st.markdown("""
    - **β (Beta)**: ความสามารถในการแพร่เชื้อ  
    - **σ (Sigma)**: ความเร็วในการเข้าสู่การติดเชื้อ  
    - **γ (Gamma)**: ความเร็วในการฟื้นตัว
    - **S (Susceptible)**: ประชากรที่เสี่ยงติดเชื้อ
    - **E (Exposed)**: ประชากรที่ได้รับเชื้อเเล้วเเต่ยังไม่เเสดงอาการ
    - **I (Infectious)**: ประชากรที่ติดเชื้อ
    - **R (Recovered)**: ประชากรที่หายจากโรค
    - **เเกน X**: จำนวนคน
    - **เเกน Y**: วัน
    """)

# 🔁 Reset
if st.button("Reset ค่า"):
